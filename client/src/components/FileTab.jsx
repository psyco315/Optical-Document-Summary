...
const FileTab = ({ fileName, isActive, onClick, onClose, showClose = true }) => (
  <div className={`relative inline-flex text-white items-center px-3 py-2 text-sm cursor-pointer border-r border-gray-400 ${isActive ? 'bg-[#2a2a2a]' : 'bg-[#0A0A0A] hover:bg-[#2a2a2a]'
    }`}>
    {isActive && (<BorderBeam />)}
